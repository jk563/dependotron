...
class SchemaGenerator:
    ...
    def createTables(self):
        if(self.dependotronCursor):
            ...
            dependenciesSQL = "CREATE TABLE IF NOT EXISTS dependencies (parent_id INT NOT NULL, descendant_id INT NOT NULL, direct_dependency BOOLEAN NOT NULL, FOREIGN KEY (parent_id) REFERENCES artifacts (artifact_id),FOREIGN KEY (descendant_id) REFERENCES artifacts (artifact_id),UNIQUE KEY (parent_id,descendant_id));"
